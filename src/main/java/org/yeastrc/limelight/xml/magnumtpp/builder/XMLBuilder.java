...
import org.yeastrc.limelight.xml.magnumtpp.annotation.PSMAnnotationTypes;
import org.yeastrc.limelight.xml.magnumtpp.annotation.PSMDefaultVisibleAnnotationTypes;
...
public class XMLBuilder {
    ...
    throws Exception {
		...
		MatchedProteinsBuilder.getInstance().buildMatchedProteins(
				...
				conversionParameters.getImportDecoys(),
